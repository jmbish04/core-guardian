  ...
  return (
    <Card className="overflow-hidden bg-gradient-to-br from-card to-card ring-1 ring-border/40">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, var(--color-chart-1), var(--color-chart-2), var(--color-chart-5))",
        }}
        aria-hidden
      />
      <CardHeader>
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="flex items-start gap-3">
            <span
              ...
              style={{ backgroundColor: "color-mix(in oklch, var(--color-chart-1) 16%, transparent)" }}
            >
              <Sparkles className="size-4.5" style={{ color: "var(--color-chart-1)" }} aria-hidden />
            </span>
            <div>
        ...
        {loading && !data ? (
          <div className="flex flex-col gap-3" aria-busy>
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Sparkles className="size-4 animate-pulse" style={{ color: "var(--color-chart-1)" }} />
              Thinking…
            </div>
