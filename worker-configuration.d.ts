/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 488ccafb0723b8c76728b1a17a1ce800)
// Runtime types generated with workerd@1.20260714.1 2026-05-25 nodejs_compat
interface __BaseEnv_Env {
	SESSION: KVNamespace;
	SESSIONS: KVNamespace;
	PROMPTS: KVNamespace;
	CIRCUITS: KVNamespace;
	...
	ANTHROPIC_ADMIN_KEY: SecretsStoreSecret;
	OPENAI_ADMIN_KEY: SecretsStoreSecret;
	GCP_BILLING_ACCOUNT_ID: SecretsStoreSecret;
	...
	INBOX_FORWARD_TO: "";
	REUI_LICENSE_KEY: string;
	CODE_MODE_AGENT: DurableObjectNamespace<import("./src/_worker").CodeModeAgent>;
	BROWSER_HITL_AGENT: DurableObjectNamespace<import("./src/_worker").BrowserHitlAgent>;
	WORKFLOWS_AGENT: DurableObjectNamespace<import("./src/_worker").WorkflowsAgent>;
	ARTIFACT_AGENT: DurableObjectNamespace<import("./src/_worker").ArtifactAgent>;
	CHAT_BROKER: DurableObjectNamespace<import("./src/_worker").ChatBroker>;
	NOTIFICATIONS_AGENT: DurableObjectNamespace<import("./src/_worker").NotificationsAgent>;
	ORCHESTRATOR_AGENT: DurableObjectNamespace<import("./src/_worker").OrchestratorAgent>;
	RESEARCHER_AGENT: DurableObjectNamespace<import("./src/_worker").ResearcherAgent>;
	CODER_AGENT: DurableObjectNamespace<import("./src/_worker").CoderAgent>;
	MCP_AGENT: DurableObjectNamespace<import("./src/_worker").McpAgent>;
	THINKING_AGENT: DurableObjectNamespace<import("./src/_worker").ThinkingAgent>;
	SKILLS_AGENT: DurableObjectNamespace<import("./src/_worker").SkillsAgent>;
	TRIM_WORKFLOW: Workflow<Parameters<import("./src/_worker").LogTrimWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_BASE_URL" | "AI_GATEWAY_ID" | "MODEL_CHAT" | "MODEL_EXTRACT" | "MODEL_DRAFT" | "MODEL_TRANSCRIBE" | "DEFAULT_MODEL_EMBEDDING" | "INBOX_FORWARD_TO" | "REUI_LICENSE_KEY">> {}
}
